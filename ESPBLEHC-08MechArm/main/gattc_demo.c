...
static const char remote_device_name[] = "RoboP-arm";
static const uint8_t remote_device_name_LEN = 9;
...
static struct gattc_profile_inst gl_profile_tab[PROFILE_NUM] = {
    [PROFILE_A_APP_ID] = {
        ...
        .remote_bda = { 0x34, 0x08, 0xE1, 0x33, 0xA0, 0xFD }
    },
};

uint8_t write_char_data[11]={0xAA,
