...
static const char remote_device_name[] = "RoboP-rocker";
static const uint8_t remote_device_name_LEN = 12;
...
static struct gattc_profile_inst gl_profile_tab[PROFILE_NUM] = {
    [PROFILE_A_APP_ID] = {
        ...
        .remote_bda = { 0x44, 0xEE, 0x14, 0x6D, 0xE0, 0xCA }
    },
};

uint8_t write_char_data[9]={0xAA,
                            0x80,0x80,//Chassis
                            0x00,0x00,0x00,0x00,
                            0x80,
                            0xEE};
...
static void gattc_profile_event_handler(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if, esp_ble_gattc_cb_param_t *param)
{
    ...
    case ESP_GATTC_WRITE_DESCR_EVT:
        ...
        get_btData(write_char_data);//获取蓝牙传输的遥控数据
    ...
    case ESP_GATTC_DISCONNECT_EVT:
        ...
        esp_ble_gap_start_scanning(30);//自动重连
        break;
    default:
        break;
    }
...
static void esp_gap_cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_SCAN_RESULT_EVT: {
        ...
        case ESP_GAP_SEARCH_INQ_RES_EVT:
            ...
            if (adv_name != NULL) {
                if (remote_device_name_LEN == adv_name_len && strncmp((char *)adv_name, remote_device_name, adv_name_len) == 0) {
                    ...
                    ESP_LOGI(GATTC_TAG, "NOT RIGHT device %s reLEN %d", remote_device_name,strlen(remote_device_name));
                }
            }
            else {
                ESP_LOGI(GATTC_TAG, "adv_name == NULL");
            }
            break;
...
void app_main(void)
{
    ...
    ESP_LOGI("ADC_Init", "ADC initialization complete");
    ...
    ESP_LOGI("GPIO_Init", "GPIO initialization complete");
