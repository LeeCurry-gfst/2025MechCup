 ...
 * min(int a, int b)
 */
#if defined STM32F4_MPU6050
#include "i2c.h"   
   
#define i2c_write(devaddr,regdaar,size,pdata)   HAL_I2C_Mem_Write(&hi2c1 ,devaddr<<1,regdaar,I2C_MEMADD_SIZE_8BIT ,pdata,size,500)	
#define i2c_read(devaddr,regdaar,size,pdata)   HAL_I2C_Mem_Read(&hi2c1 ,devaddr<<1,regdaar,I2C_MEMADD_SIZE_8BIT ,pdata,size,500)
