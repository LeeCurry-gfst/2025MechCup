/***************************************************************************************
本部分代码基于江协科技开源的OLED驱动控制代码移植修改而成
  ***************************************************************************************
  */
/***************************************************************************************
  * 本程序由江协科技创建并免费开源共享
...
#define Software_IIC_GPIO_SCL GPIO_PIN_8 //软件模拟iic端口配置
#define Software_IIC_GPIO_SDA GPIO_PIN_9 //软件模拟iic端口配置
#define Software_IIC_GPIO GPIOB//软件模拟iic端口配置
#define __HAL_RCC_Sofware_IIC_CLK_ENABLE() __HAL_RCC_GPIOB_CLK_ENABLE()//时钟配置
/**
  * 数据存储格式：
...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(Software_IIC_GPIO, Software_IIC_GPIO_SCL, (GPIO_PinState)(BitValue));
	for(int i=1;i<=10;i++);
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(Software_IIC_GPIO, Software_IIC_GPIO_SDA, (GPIO_PinState)(BitValue));
	for(int i=1;i<=10;i++);
	/*如果单片机速度过快，可在此添加适量延时，以避免超出I2C通信的最大速度*/
	//...
}
...
void OLED_GPIO_Init(void)
{
    ...
    __HAL_RCC_Sofware_IIC_CLK_ENABLE();
    
    GPIO_InitStruct.Pin = Software_IIC_GPIO_SCL|Software_IIC_GPIO_SDA;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(Software_IIC_GPIO, &GPIO_InitStruct);
