...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, DIR_Pin|MS1_Pin|MS2_Pin|EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DIR_Pin MS1_Pin MS2_Pin EN_Pin */
  GPIO_InitStruct.Pin = DIR_Pin|MS1_Pin|MS2_Pin|EN_Pin;
